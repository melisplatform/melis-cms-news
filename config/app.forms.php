        ...
        'MelisCmsNews' => [
            ...
            'forms' => [
               ...
               'meliscmsnews_seo_form' => [
                ...
                'meliscmsnews_comment_form' => [
                    'attributes' => [
                        'name' => 'meliscmsnewscomments',
                        'id' => 'idmeliscmsnewscomments',
                        'method' => 'POST',
                        'action' => '',
                    ],
                    ...
                    'elements' => [
                        [
                            'spec' => [
                                'name' => 'cnews_com_title',
                                'type' => 'MelisText',
                                'options' => [
                                    'label' => 'tr_meliscmsnews_comments_title',
                                ],
                                'attributes' => [
                                    'id' => 'id_cnews_com_title',
                                    'value' => '',
                                ],
                            ],
                        ],
                        [
                            'spec' => [
                                ...
                                'type' => 'Textarea',
                                'options' => [
                                    'label' => 'tr_meliscmsnews_comments_content',
                                ],
                                'attributes' => [
                                    'id' => 'id_cnews_com_text',
                                    'value' => '',
                                    'class' => 'form-control news-wf-comment-area',
                                    'style' => 'max-width:100%',
                                    'rows' => '4',
                                ],
                            ],
                            ...
                            'validators' => [
                                [
                                    ...
                                    'options' => [
                                        ...
                                        'max'      => 255,
                                        'messages' => [
                                            \Laminas\Validator\StringLength::TOO_LONG => 'tr_meliscmsnews_comments_title_long',
                                        ],
                                    ],
                                ],
                                [
                                    ...
                                    'options' => [
                                        'messages' => [
                                            \Laminas\Validator\NotEmpty::IS_EMPTY => 'tr_meliscmsnews_comments_title_empty',
                                        ],
                                    ],
                                ],
                            ],
                        ...
                        'cnews_com_text' => [
                            ...
                            'validators' => [
                                [
                                    ...
                                    'options' => [
                                        'messages' => [
                                            \Laminas\Validator\NotEmpty::IS_EMPTY => 'tr_meliscmsnews_comments_content_empty',
                                        ],
                                    ],
                                ],
                            ],
