...
use MelisCmsNews\View\Helper\MelisCmsNewsListHelper;

class MelisCmsNewsListHelperFactory implements FactoryInterface
{
	public function createService(ServiceLocatorInterface $sl)
	{
		...
		$helper = new MelisCmsNewsListHelper($serviceLoc, $renderMode, $preview);
