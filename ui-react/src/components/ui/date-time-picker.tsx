 ...
 * NAVIGATEUR, pas celle de la page (l'attribut `lang` est ignoré par Chromium pour ça) → un BO
 * français sur un Chrome anglais montre un calendrier anglais. On rend donc notre propre calendrier,
 * localisé via `Intl` (noms de mois, en-têtes de jours, 1er jour de semaine) → fonctionne pour
 * n'importe quelle langue du BO.
 *
